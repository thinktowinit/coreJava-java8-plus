...
public class MyDataBaseDoctorUtils {
	...
	private static List<Doctor> createDoctorAndAddToList(List listBox) {
		...
		//doctor6.setExperience(4);
		doctor61.setExperience(1);
		doctor1.setJoiningDate(LocalDate.of(2015, 6, 1)); // Joined June 1, 2015
		...
		//doctor6.setJoiningDate(LocalDate.of(2022, 7, 20));
		...
		System.out.println("Doctor " + doctor.getName() + " joined on: " + doctor.getFormattedJoiningDateTime());
		Doctor doctort1 = new Doctor();
		doctort1.setName("Naveen");
		doctort1.setJoiningDate(LocalDate.of(2024, 6, 28)); // Just a date, no time

		System.out.println("Doctor " + doctort1.getName() + " joined on: " + doctort1.getFormattedJoiningDateTime());
