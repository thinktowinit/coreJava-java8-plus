...
public class MyDataBaseUtil {
	...
	private static List<Farmer> createFarmerAndAddToList(List listBox) {
		...
		farmer1.setJoiningDate(LocalDateTime.of(2019, 5, 10, 0, 0)); // at least 2 years ago;// Format: LocalDateTime.of(year, month, day,
																			// hour, minute, second)
		...
		farmer2.setJoiningDate(LocalDateTime.of(2019, 5, 10, 0, 0)); // at least 2 years ago// Format: LocalDateTime.of(year, month, day,
		// hour, minute, second)
		...
		farmer2.setBloodGroup(BloodGroup.O_NEGATIE);
		farmer3.setJoiningDate(LocalDateTime.of(2024, 6, 28, 6, 55, 23));// Format: LocalDateTime.of(year, month, day,
		// hour, minute, second)
		...
		farmer4.setJoiningDate(LocalDateTime.of(2024, 6, 28, 6, 55, 23));// Format: LocalDateTime.of(year, month, day,
		// hour, minute, second)
		...
		farmer5.setJoiningDate(LocalDateTime.of(2024, 6, 28, 6, 55, 23));// Format: LocalDateTime.of(year, month, day,
		// hour, minute, second)
		...
		farmer6.setJoiningDate(LocalDateTime.of(2024, 6, 28, 6, 55, 23));// Format: LocalDateTime.of(year, month, day,
		// hour, minute, second)
